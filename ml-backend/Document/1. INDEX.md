...
## 🎯 Optimización ML - Mayo 2026

### Mejoras de Matriz de Confusión
10. **[13_OPTIMIZACION_MATRIZ_CONFUSION_MAYO2026.md](13_OPTIMIZACION_MATRIZ_CONFUSION_MAYO2026.md)** - ⭐ NUEVO
   - Focal Loss v2 mejorada (gamma=2.8, alpha=0.35)
   - Estrategia de pesos dinámicos (pos_weight_factor=2.5)
   - Optimización de umbral en 2 fases
   - Arquitecturas refactorizadas (LSTM v1, v2, CNN v3)
   - Validador de balance de clases
   - Parámetros configurables
   - Resultados esperados: -24% FP, +30% TN

**Cambios implementados:**
- ✅ 5 fases de optimización completadas
- ✅ Torres separadas en arquitecturas
- ✅ Búsqueda de umbral refinada (basica + fina)
- ✅ Balance de pérdidas 0.4 regresión / 0.6 clasificación
- ✅ Validador automático de balance de clases
- ✅ +50% capacidad en canales/hidden layers

**Cómo empezar:**
```python
# Los cambios se aplican automáticamente:
from app.ml.pipeline_cnn.trainer import ejecutar_entrenamiento_cnn
resultado = ejecutar_entrenamiento_cnn(model, train_loader, val_loader, device)
# Usa automáticamente: Focal Loss v2, pos_weight=2.5, umbral adaptativo, etc.
```

**Parámetros que puedes cambiar:**
- Gamma (2.0-4.0): Enfoque en ejemplos difíciles
- Alpha (0.2-0.5): Penalización de clase positiva
- pos_weight_factor (1.0-5.0): Penalización de falsos positivos
- Learning rate, weight decay, early stopping patience, etc.

### Configuración Parametrizable
11. **[14_GUIA_PARAMETROS_CONFIGURABLES.md](14_GUIA_PARAMETROS_CONFIGURABLES.md)** - ⭐ NUEVO
   - Todos los parámetros que puedes cambiar
   - Rango recomendado para cada parámetro
   - Cómo cambiar cada parámetro
   - Impacto en matriz confusión
   - 4 escenarios recomendados (Conservador, Balance, Liberal, Rápido)
   - Debugging: qué cambiar si hay problemas

**Parámetros cubiertos:**
- ✅ Focal Loss (gamma, alpha, pos_weight_factor)
- ✅ Optimizador (lr, weight_decay, eta_min, max_norm)
- ✅ Balance de pérdidas (reg/clf weights, factor castigo)
- ✅ Early Stopping (paciencia, delta)
- ✅ Umbral de decisión (automático, personalizable)
- ✅ Arquitectura (hidden_size, dropout, conv channels)

**Ejemplos rápidos:**
```python
# Reducir FP: gamma=3.0, alpha=0.45, pos_weight_factor=3.5
# Balance:    gamma=2.8, alpha=0.35, pos_weight_factor=2.5  ← ACTUAL
# Recall:     gamma=2.0, alpha=0.25, pos_weight_factor=1.5
```

### Referencia Rápida
12. **[15_CHEATSHEET_REFERENCIA_RAPIDA.md](15_CHEATSHEET_REFERENCIA_RAPIDA.md)** - ⭐ NUEVO
   - Cheatsheet para acceso rápido
   - Códigos prontos para copiar/pegar
   - Escenarios rápidos (FP alto, Recall bajo, etc.)
   - Debugging en 1 línea
   - Comandos útiles
   - El cambio MÁS impactante

**Secciones:**
- ✅ Entrenar en 5 líneas (LSTM/CNN)
- ✅ Cambiar parámetros clave
- ✅ 4 escenarios rápidos
- ✅ Evaluar modelo en 3 líneas
- ✅ Debugging rápido (tabla)
- ✅ Métricas esperadas
